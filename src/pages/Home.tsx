...
import { Search, ShieldAlert, ShieldCheck, AlertTriangle, CheckCircle, Loader2, Upload, X, Image as ImageIcon, CreditCard, Lock, Crown, Share2, Copy, Cpu, Check, Scan, Ban, Briefcase, MapPin, ArrowRight, Info } from 'lucide-react';
import { analyzeQuery, ScamAnalysisResult } from '../services/ai';
import { saveSearch, checkBlacklist, decrementCredits } from '../services/firestore';
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="relative flex-grow">
                ...
                <select
                  ...
                  className="block w-full pl-11 pr-10 py-4 bg-stone-50 border border-stone-300 rounded-xl text-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-shadow appearance-none"
                >
                  <option value="" disabled>Choose an ID option...</option>
