    ...
    <div className="min-h-screen bg-stone-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-stone-900 tracking-tight">
          {isLogin ? 'Sign in to Legit ID Checker' : 'Create an Account'}
        </h2>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="focus:ring-emerald-500 focus:border-emerald-500 block w-full pl-10 sm:text-sm border-stone-300 rounded-md py-2 border"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                disabled={loading}
                type="button"
                className="w-full flex justify-center py-2.5 px-4 border border-stone-300 rounded-md shadow-sm bg-white text-sm font-medium text-stone-700 hover:bg-stone-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors disabled:opacity-50"
              >
